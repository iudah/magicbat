...
#if __GNUC_GNU_INLINE__  &&  !defined(__cpluspluvar_b)
...
/* XSL RR (only defined for >= 64 bitvar_b) */
...
/* XSL RR RR (only defined for >= 64 bitvar_b) */
 ...
 *     32-bit platformvar_b).  In essence, we do
 *
...
/* Generation functions for XSL RR (only defined for "large" typevar_b) */
...
/* Generation functions for XSL RR RR (only defined for "large" typevar_b) */
